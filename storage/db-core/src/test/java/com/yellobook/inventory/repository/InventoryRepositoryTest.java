...
//
//import com.yellobook.storage.db.core.inventory.dto.query.QueryInventory;
...
//
//            for (int i = 0; i < 5; i++) {
//                ProductEntity product = createProduct(String.format("product%d", i), String.format("sub%d", i), i,
//                        i * 1000,
...
//        void setUpContext() {
//            team = em.persist(createTeam("팀1"));
//            InventoryEntity inventory = createInventory(team);
//            em.persist(inventory);
//
//            for (int i = 0; i < 5; i++) {
//                ProductEntity product = createProduct(String.format("product%d", i), String.format("sub%d", i), i,
...
//                em.clear();
//
//                InventoryEntity updatedInventory = inventoryRepository.findById(inventory.getId())
//                        .orElse(null);
//
