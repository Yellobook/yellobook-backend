    ...
    class Describe_FindById {
        ...
        class Context_exist_inform {
            ...
            void it_returns_inform() {
                Optional<InformEntity> foundInform = informRepository.findById(informId);
        ...
        class Context_not_exist_inform {
            ...
            void it_returns_OptionalEmpty() {
                Optional<InformEntity> foundInform = informRepository.findById(nonExistentInformId);
