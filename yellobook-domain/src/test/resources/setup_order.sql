...
VALUES (1, '팀 A', '010-1234-5678', '서울특별시', '2024-07-25 10:00:00', '2024-07-25 10:00:00'),
...
VALUES (1, '사용자1', 'user1@example.com', 'profile1.png', 'USER', true, '2024-07-25 10:00:00', '2024-07-25 10:00:00'),
...
VALUES (1, 1, '2024년 07월 25일 재고현황', 10, '2024-07-25 10:00:00', '2024-07-25 10:00:00'),
       (2, 1, '2024년 07월 25일 재고현황', 5, '2024-07-25 10:00:00', '2024-07-25 10:00:00');

-- 제품 데이터 삽입
INSERT INTO products (id, name, sub_product, sku, purchase_price, sale_price, amount, inventory_id, created_at,
                      updated_at)
VALUES (1, '제품 A', '서브제품1', 1001, 500, 700, 50, 1, '2024-07-25 10:00:00', '2024-07-25 10:00:00'),
       (2, '제품 B', '서브제품2', 1002, 400, 600, 30, 1, '2024-07-25 10:00:00', '2024-07-25 10:00:00');

-- 주문 데이터 삽입
INSERT INTO orders (id, view, memo, date, order_status, order_amount, product_id, member_id, team_id, created_at,
                    updated_at)
VALUES (1, 10, '메모1', '2024-07-26', 'CONFIRMED', 10, 1, 2, 1, '2024-07-25 10:00:01', '2024-07-25 10:00:01'),
...
VALUES (1, '댓글1', 1, 1, '2024-07-25 10:00:01', '2024-07-25 10:00:01'),
...
VALUES (1, 1, 1, '2024-07-25 10:00:01', '2024-07-25 10:00:01');
