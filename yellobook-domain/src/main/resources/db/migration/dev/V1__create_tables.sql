...
CREATE TABLE public.inform_comments
(
...
CREATE TABLE public.inform_mentions
(
...
CREATE TABLE public.order_mentions
(
    id         BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- 멘션 ID (기본 키)
    member_id  BIGINT NOT NULL
