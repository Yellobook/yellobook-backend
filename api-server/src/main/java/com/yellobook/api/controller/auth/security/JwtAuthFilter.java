package com.yellobook.api.controller.auth.security;

import com.yellobook.api.controller.auth.security.oauth2.dto.CustomOAuth2User;
import com.yellobook.api.controller.auth.security.oauth2.dto.OAuth2User;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        try {
            ...
            if (!jwtService.isAccessTokenExpired(accessToken)
                ...
                OAuth2User oauth2UserDTO = OAuth2User.from(member);
