package com.yellobook.controller.schedule.strategy;
...
public interface ScheduleStrategy {
    ...
    SearchMonthlyScheduleResponse searchMonthlySchedules(MonthlySearchParam monthlySearchParam,
    ...
    default QueryUpcomingSchedule selectSchedule(QueryUpcomingSchedule order, QueryUpcomingSchedule inform) {
        ...
        if (order != null && inform != null) {
            ...
            return inform.day()
                    .isBefore(order.day()) ? inform : order;
        }
     ...
     * @param o1 일정
     * @param o2 일정
     * @return 정렬을 위한 정수 - 양수일경우 o1 이 앞으로, 0 일경우 유지, 음수일경우 o2 가 앞으로
     */
