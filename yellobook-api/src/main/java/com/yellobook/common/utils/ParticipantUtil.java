...
public class ParticipantUtil {
     ...
     * 관리자는 접근 불가능
     */
    public static void forbidAdmin(MemberTeamRole role){
     ...
     * 주문자는 접근 불가능
     */
    public static void forbidOrderer(MemberTeamRole role){
     ...
     * 뷰어는 접근 불가능
     */
    public static void forbidViewer(MemberTeamRole role){
