...
public enum CoreErrorType {
    ...
    USER_NOT_IN_THE_TEAM(CoreErrorCode.TEAM03, CoreErrorKind.FORBIDDEN, "팀에서 해당 사용자를 찾을 수 없습니다.", CoreErrorLevel.WARN),
    ...
    MENTIONED_MEMBER_NOT_FOUND(CoreErrorCode.TEAM12, CoreErrorKind.NOT_FOUND, "존재하지 않는 사용자에 대한 언급입니다.",
            CoreErrorLevel.WARN),
    ONLY_SELLER_CAN_UPDATE(CoreErrorCode.TEAM13, CoreErrorKind.FORBIDDEN, "오직 판매자만 변경할 수 있는 정보 입니다.",
            CoreErrorLevel.WARN),
    DID_NOT_APPLY(CoreErrorCode.TEAM14, CoreErrorKind.CONFLICT, "가입 요청을 한적 없습니다.", CoreErrorLevel.WARN),
    SELLER_AND_ORDERER_CAN_UPDATE_JOIN_REQUEST(CoreErrorCode.TEAM15, CoreErrorKind.FORBIDDEN,
    ...
    ONLY_VIEWER_CAN_REQUESTED_ORDERER_CONVERSION(CoreErrorCode.TEAM17, CoreErrorKind.FORBIDDEN,
    ...
    ROLE_CONVERSION_NOT_FOUND(CoreErrorCode.TEAM19, CoreErrorKind.NOT_FOUND, "권한 변경 요청이 존재하지 않습니다.",
            CoreErrorLevel.WARN),
    SELLER_MUST_EXIST_IN_TEAM(CoreErrorCode.TEAM20, CoreErrorKind.FORBIDDEN, "팀에는 한명 이상의 판매자가 존재해야합니다.",
            CoreErrorLevel.WARN),
    CAN_INVITE_ORDERER(CoreErrorCode.TEAM21, CoreErrorKind.FORBIDDEN, "주문자를 팀에 초대할 수 없습니다.",
            CoreErrorLevel.WARN),
