package com.yellobook.core.api.domains.inventory.utils;
...
public class ExcelReadUtil {
     ...
     */
    private boolean isRowValid(String name, String subProduct, Integer sku, Integer purchasePrice, Integer salePrice,
                               Integer amount) {
