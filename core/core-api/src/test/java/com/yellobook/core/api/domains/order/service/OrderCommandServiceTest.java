package com.yellobook.core.api.domains.order.service;
...
import com.yellobook.core.api.domains.order.mapper.OrderMapper;
import com.yellobook.core.domains.order.repository.OrderCommentRepository;
import com.yellobook.core.domains.order.repository.OrderMentionRepository;
...
class OrderCommandServiceTest {
    ...
    class Describe_ModifyRequestOrder {
        ...
        class Context_not_order_admin {
            ...
            void setUpContext() {
                orderId = 1L;
                order = OrderFixture.createOrder(null, null, null, OrderStatus.PENDING_CONFIRM);
        ...
        class Context_order_confirmed {
            ...
            void setUpContext() {
                orderId = 1L;
                order = OrderFixture.createOrder(null, null, null, OrderStatus.CONFIRMED);
                when(orderRepository.findById(orderId)).thenReturn(Optional.of(order));
                when(orderMentionRepository.existsByMemberIdAndOrderId(admin.getMemberId(), order.getId())).thenReturn(
                        true);
            }
        ...
        class Context_can_request_modify_order {
            ...
            void it_request_modify_order() {
                ...
                org.assertj.core.api.Assertions.assertThat(order.getOrderStatus())
                        .isEqualTo(OrderStatus.PENDING_MODIFY);
                verify(orderRepository).findById(orderId);
                verify(orderMentionRepository).existsByMemberIdAndOrderId(admin.getMemberId(), order.getId());
            }
        }
    ...
    class Describe_ConfirmOrder {
        ...
        class Context_order_pending_modify {
            ...
            void setUpContext() {
                orderId = 1L;
                order = OrderFixture.createOrder(null, null, null, OrderStatus.PENDING_MODIFY);
                when(orderRepository.findById(orderId)).thenReturn(Optional.of(order));
                when(orderMentionRepository.existsByMemberIdAndOrderId(admin.getMemberId(), order.getId())).thenReturn(
                        true);
            }
    ...
    class Describe_CancelOrder {
        ...
        class Context_not_my_order {
            ...
            void setUpContext() {
                ...
                Order order = OrderFixture.createOrder(null, member, null, OrderStatus.PENDING_MODIFY);
                when(orderRepository.findById(orderId)).thenReturn(Optional.of(order));
            }
        ...
        class Context_order_not_pending_modify {
            ...
            void setUpContext() {
                ...
                Order order = OrderFixture.createOrder(null, member, null, OrderStatus.CONFIRMED);
                when(orderRepository.findById(orderId)).thenReturn(Optional.of(order));
            }
        ...
        class Context_can_cancel_order {
            ...
            void setUpContext() {
                orderId = 1L;
                Member member = createMemberWithId(1L);
                order = OrderFixture.createOrder(null, member, null, OrderStatus.PENDING_MODIFY);
                when(orderRepository.findById(orderId)).thenReturn(Optional.of(order));
            }
    ...
    class Describe_AddOrderComment {
        ...
        class Context_not_order_orderer {
            ...
            void setUpContext() {
                ...
                Order order = OrderFixture.createOrder(null, orderMember, null, OrderStatus.PENDING_CONFIRM); // 1L
        ...
        class Context_not_order_admin {
            ...
            void setUpContext() {
                ...
                Order order = OrderFixture.createOrder(null, orderMember, null, OrderStatus.PENDING_CONFIRM); // 2L
