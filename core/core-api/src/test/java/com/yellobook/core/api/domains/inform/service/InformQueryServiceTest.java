...
import com.yellobook.core.api.domains.inform.dto.response.GetInformResponse.CommentItem;
import com.yellobook.core.api.domains.inform.dto.response.GetInformResponse.MentionItem;
            ...
            void setUp() {
                ...
                when(informMapper.toGetInformResponseDTO(inform, inform.getComments(),
                        ...
                        .thenReturn(new GetInformResponse("test", "test", "test",
                                List.of(new MentionItem(2L, "test")),
                                10,
        ...
        class Context_Exist_Inform_And_Author {
            ...
            void setUp() {
                ...
                when(informMapper.toGetInformResponseDTO(inform, inform.getComments(),
                        List.of(author)))
                        .thenReturn(new GetInformResponse("test", "test", "test",
                                List.of(new MentionItem(1L, "test")),
                                10,
