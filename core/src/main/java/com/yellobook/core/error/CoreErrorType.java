...
public enum CoreErrorType {
    ...
    TEAM_INVENTORY_EMPTY(CoreErrorCode.INVENTORY006, CoreErrorKind.NOT_FOUND, "팀에 재고 현황이 존재하지 않습니다",
            CoreErrorLevel.WARN),
    ONLY_SELLER_CAN_MANIPULATE_INVENTORY(CoreErrorCode.INVENTORY007, CoreErrorKind.FORBIDDEN, "오직 관리자만 재고를 관리할 수 있습니다.",
            CoreErrorLevel.WARN),
    ...
    TEAM_MEMBER_NOT_FOUND(CoreErrorCode.TEAM005, CoreErrorKind.NOT_FOUND, "팀에서 해당 사용자를 찾을 수 없습니다.",
            CoreErrorLevel.WARN),
    ONLY_SELLER_CAN_MAKE_CODE(CoreErrorCode.TEAM006, CoreErrorKind.FORBIDDEN, "오직 관리자만 초대 코드를 생성할 수 있습니다.",
            CoreErrorLevel.WARN),
    SELLER_EXISTS(CoreErrorCode.TEAM007, CoreErrorKind.CONFLICT, "관리자가 이미 존재합니다.", CoreErrorLevel.ERROR),
    ...
    MENTIONED_MEMBER_NOT_FOUND(CoreErrorCode.TEAM012, CoreErrorKind.NOT_FOUND, "존재하지 않는 사용자에 대한 언급입니다.",
            CoreErrorLevel.WARN),
    ONLY_SELLER_CAN_UPDATE(CoreErrorCode.TEAM013, CoreErrorKind.CONFLICT, "오직 관리자만 변경할 수 있는 정보 입니다.",
            CoreErrorLevel.WARN),
    DID_NOT_APPLY(CoreErrorCode.TEAM014, CoreErrorKind.CONFLICT, "가입 요청을 한적 없습니다.", CoreErrorLevel.WARN),
    SELLER_AND_ORDERER_CAN_UPDATE_JOIN_REQUEST(CoreErrorCode.TEAM015, CoreErrorKind.CONFLICT,
    ...
    ROLE_CONVERSION_NOT_FOUND(CoreErrorCode.TEAM019, CoreErrorKind.NOT_FOUND, "권한 변경 요청이 존재하지 않습니다.",
            CoreErrorLevel.WARN),
    SELLER_MUST_EXIST_IN_TEAM(CoreErrorCode.TEAM020, CoreErrorKind.CONFLICT, "팀에는 한명 이상의 판매자가 존재해야합니다.",
            CoreErrorLevel.WARN),
    ROLE_DESCRIPTION_NOT_FOUND(CoreErrorCode.TEAM021, CoreErrorKind.NOT_FOUND, "존재하지 않는 역할의 description 입니다.",
            CoreErrorLevel.WARN);
